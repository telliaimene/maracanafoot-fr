                ...
                <div className="foot-container">
                    <div className="row">
                        <div className="col-md-9 text-neutral-900 dark:text-neutral-200">
                            <h4 className="text-neutral-900 dark:text-neutral-100">CALENDRIER </h4>
            ...
            <br />
                            <div className="row">
                                <div className="col-sm-12">
                                    ...
                                    <a style={{textDecoration: "none"}} href="matches.html" className="item">
                                            <span className="championship">National cup - quarterfinal</span>
                                            <span className="teams-wrap">
                                                <span className="team"><span><img src="images/amfootball/team-logo1.png" alt="team-logo" /></span><span>Valencia Valencia</span></span>
                                                <span className="score"><span>3:2</span></span>
