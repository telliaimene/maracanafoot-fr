...
const FennecsPage = () => {
  ...
  async function getFlashInfos() {
    let URL = 'v1/articles-bysportSpliceALL2Fennecs/FR'
  ...
  async function getarticleInternationals() {
    await axios
      .get(API_LINK + "v1/articles-bysportSpliceALL2Fennecs/FR")
      .then((response) => {
        let table = response.data.map((item: ArticleType) => {
  ...
  async function getarticleInternationals3() {
    console.log("internationnal3 test", API_LINK + "v1/articles-bysportSpliceALL3Fennec/FR")

    await axios
      .get(API_LINK + "v1/articles-bysportSpliceALL3Fennec/FR")
      .then((response) => {
        let table = response.data.map((item: ArticleType)=>{
  ...
  async function getarticleInternationals4() {
    ...
    await axios
      .get(API_LINK + "v1/articles-bysportSpliceFennecsALL4/FR")
      .then((response) => {
        let table = response.data.map((item: ArticleType)=>{
  ...
  async function getarticleInternationals2() {
    await axios
      .get(API_LINK + "v1/articles-bysportFennecsSplice2/FR/Football")
      .then((response) => {
          let table = response.data.map((item: ArticleType)=>{
