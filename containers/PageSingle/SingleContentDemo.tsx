...
import { Markup } from "interweave";import { CommentDataType ,CommentType,TaxonomyType,PostDataType} from "../../data/types";
import React, { FC, useEffect, useRef, useState } from "react";
export interface SingleContentDemoProps {
  data: string ;
}
const SingleContentDemo: FC<SingleContentDemoProps> = ({data}) => {
  return (
    <>
      {/* THIS IS THE DEMP CONTENT */}
      {/* IF YOUR DATA IS JSON, YOU CAN USE render with html-react-parser (https://www.npmjs.com/package/html-react-parser) */}
     <div ><Markup className={"noselect font-normal text-justify  block text-neutral-900 dark:text-neutral-100"} 
                      content={data ? data : "Information indisponible"}
                    /></div>
