...
import { ArticleDataType, ArticleType, PostDataType } from "../../data/types";
...
const id= meta._id 
const bookmark= meta?meta.bookmarked.length > 0  ? true : false:false
const countLikes = meta?.likes ? meta.likes.length : 0
