...
const Tag: FC<TagProps> = ({ className = "", tag,type, hideCount = false }) => {
  ...
  return (
    ...
    >
      ...
      <a href={'/'}   style={{color:"#fff", backgroundColor:"#000"}}       className={`nc-Tag inline-block text-sm text-neutral-600 dark:text-neutral-300 py-2 px-3 rounded-lg  border-neutral-100 md:py-2.5 md:px-4 bg-neutral-50 dark:bg-neutral-700 dark:border-neutral-700 hover:border-neutral-200 dark:hover:border-neutral-6000  ${className}`}
>
