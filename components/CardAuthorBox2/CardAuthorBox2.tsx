...
// import { ArrowRightIcon } from "@headlessui/react/solid";
...
>
    ...
    >
      <>
          <a href={href} className={`nc-CardAuthorBox2 flex flex-col overflow-hidden [ nc-box-has-hover ] [ nc-dark-box-bg-has-hover ] ${className}`}>
