...
const CardAuthorBox: FC<CardAuthorBoxProps> = ({ className = "", author }) => {
  ...
  return (
    ...
    <div data-nc-id="CardAuthor2" >
    <Link
      href={href}
      
    >
      <>
          <a href={href} className={`nc-CardAuthorBox flex flex-col items-center justify-center text-center px-3 py-5 sm:px-6 sm:py-7  [ nc-box-has-hover ] [ nc-dark-box-bg-has-hover ] ${className}`}>
