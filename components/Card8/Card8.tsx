...
const Card8: FC<Card8Props> = ({ className = "h-full", post }) => {
  ...
  return (
    ...
    >
      ...
      >
        <>
        <a href={href} className="block w-full h-0 pt-[100%] sm:pt-[55%] rounded-xl overflow-hidden">
        <NcImage
          prevImageHorizontal
      ...
      >
        <a href={href} className="absolute inset-x-0 bottom-0 top-1/3 bg-gradient-to-t from-neutral-900 "></a>
      </Link>
