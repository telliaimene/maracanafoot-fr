...
const Card17Podcast: FC<Card17PodcastProps> = ({ className = "", post }) => {
  ...
  const renderDefaultBtnListen = (state?: "loading" | "playing") => {
    return (
      <span className="w-11 h-11 flex items-center justify-center rounded-full   dark:bg-neutral-800 text-primary-6000 dark:text-primary-200 shadow-lg cursor-pointer">
        {renderIcon(state)}
      </span>
    );
  };
