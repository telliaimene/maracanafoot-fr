...
const CardCategory5: FC<CardCategory5Props> = ({
  ...
  className={`nc-CardCategory5 relative block group ${className}`}
    ...
    >
      <>
          <a href={href} className={`nc-CardCategory5 relative block group ${className}`}>
      <div
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <h2
          className={`text-base font-medium px-4 py-2 sm:px-6 sm:py-3   text-neutral-900 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-full border-2 border-white border-opacity-60`}
        >
